...
PROMPT_TEMPLATE = (
    ...
    "see blurry / smeared / hollow regions where they used to be. A "
    "region that is FORMLESS blur with no recognizable object shape is "
    "removal residue — skip it. But do NOT skip something just because "
    "it looks blurry: splat furniture often renders soft and fuzzy, so "
    "if a blurry area still has a recognizable furniture shape, treat it "
    "as a real object that may have been missed.\n\n"
    ...
    "furniture.\n"
    "  • Any free-standing piece of furniture resting on the floor that "
    "still appears SOLID and intact (side tables, end tables, accent or "
    "console tables, stools, benches, small cabinets, etc.). Furniture "
    "that inventory already removed looks blurry / smeared / hollow — so "
    "a solid, intact furniture piece means inventory missed it: list it.\n"
    "{extra_keep}\n"
